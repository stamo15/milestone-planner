                                                ...
                                                <div class="responsive-table table-status-sheet">
                                                    <table class="border yellow">
                                                        ...
                                                        <tbody>
                                                                                    ...
                                                                                    <div class="card blue-grey darken-1">
                                                                                        ...
                                                                                        <div class="card-action center">
                                                                                            <ul class="list-inline">
                                                                                                ...
                                                                                                <li><a data-target="share-milestone-modal${milestone.getId()}" href="!#" class="modal-trigger"><i class="material-icons">share</i></a></li>
                                                                                            </ul>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                            ...
                                                            <a  data-target="get-shared-milestone-modal${user.getId()}" href="!#" class="btn-floating btn-large waves-effect waves-light red modal-trigger"><i class="material-icons">add</i></a>
...
<%--                                                                                                <div class="input-field col s12">--%>
<%--                                                                                                    <i class="material-icons prefix">description</i>--%>
<%--                                                                                                    <input type="text" name="url" placeholder="Milestone description" id="url${milestone.getId()}" value="${milestone.getHash()}">--%>
