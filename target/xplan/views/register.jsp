...
<head>
    ...
    <title>MilestonePlanner | Sign up</title>
</head>
    ...
    <div  class="row">
        <div class="col s12 l10 offset-l1">
            <ul class="tabs tabs-fixed-width z-depth-1">
                <li class="tab white"><a class="light-green-text text-accent-4 text-bold" href="#login-form">Login</a></li>
                <li class="tab white"><a class="light-green-text text-accent-4 text-bold active" href="#registration-form">Register</a></li>
            </ul>
        </div>
    </div>
    <div  class="row">
